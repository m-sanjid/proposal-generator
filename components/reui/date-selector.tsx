...
export interface DateSelectorProps {
  ...
  weekStartsOn?: 0 | 1 | 2 | 3 | 4 | 5 | 6
  /** Hides filter/period controls for single-date form fields */
  simple?: boolean
}
...
export function DateSelector({
  ...
  return (
    ...
    >
      <div className={cn(simple ? "w-full space-y-3" : "w-full space-y-4 sm:w-[470px]", className)}>
        {!simple && (
